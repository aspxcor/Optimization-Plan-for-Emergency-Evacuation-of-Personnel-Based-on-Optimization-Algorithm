...
r = [[726, 1064, 651, 640],  # Oracle
     [762, 884, 676,687],  # GDB
     [752,      951,		644,650]#,    #SQLITE
     ]
w = [[400, 400, 400,400],  # Oracle
     [212, 244, 223,212],  # GDB
     [211, 255, 229,240]#,  # SQLITE
     ]
# 这是柱图x轴标签
...
def DrawGeoDtaabse(rcount, wcount, y):
    ...
    y4 = [i[3] for i in rcount]  # y轴面效率位置
    # 占位以免 数据源标签丢失
    # y0 = ["", "", "", "", "", "", "", ""]
    y0 = ["", "", ""]
    ...
    plt.bar(x2, y2, alpha=0.7, width=0.9, color='g', label="遗传算法3", tick_label=y0)
    plt.bar(x4, y4, alpha=0.7, width=0.9, color='yellow', label="遗传算法4", tick_label=y)
    # plt.legend()
